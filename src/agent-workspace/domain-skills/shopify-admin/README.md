...
Mike (or the human owner) must be logged into `admin.shopify.com` in the Chrome session that browser-agent attaches to. The harness does NOT log in — it inherits the human's session.
